        ...
        def __init__(self, v1: 'int', v3: 'int'=_HAS_DEFAULT_FACTORY, v2: 'int'=_HAS_DEFAULT_FACTORY):
            ...
            if v3 is _HAS_DEFAULT_FACTORY:
                ...
                for _yidl_factory_param__astichi_scoped_2 in ('v2', 'v1'):
                    _yidl_factory_args__astichi_scoped_1[_yidl_factory_param__astichi_scoped_2] = locals()[_yidl_factory_param__astichi_scoped_2]
                v3 = _yidl_default_factories['Example.v3'](**_yidl_factory_args__astichi_scoped_1)
            setattr(self, 'v1', v1)
            setattr(self, 'v3', v3)
            setattr(self, 'v2', v2)
            pass
