...
_ActionIdProperty = RuntimeProperty(
    "ActionId", str, default=REQUIRED, storage_name="action_id"
)
_ActionOwnerProperty = RuntimeProperty(
    "ActionOwner", str, default=REQUIRED, storage_name="action_owner"
)
_ActionFieldIdProperty = RuntimeProperty(
    "ActionFieldId", str, default=REQUIRED, storage_name="action_field_id"
)
_ActionFieldNameProperty = RuntimeProperty(
    "ActionFieldName", str, default=REQUIRED, storage_name="action_field_name"
)
_ActionFieldOrderProperty = RuntimeProperty(
    "ActionFieldOrder", int, default=REQUIRED, storage_name="action_field_order"
)
...
_ActionDefaultFactoryParamNameProperty = RuntimeProperty(
    "ActionDefaultFactoryParamName",
    str,
    default=REQUIRED,
    storage_name="action_default_factory_param_name",
)
...
_ProviderDefaultValueParamNameProperty = RuntimeProperty(
    "ProviderDefaultValueParamName",
    str,
    default="",
    storage_name="provider_default_value_param_name",
)
...
_EvalOrderProperty = RuntimeProperty(
    "EvalOrder", int, default=REQUIRED, storage_name="eval_order"
)
...
_DiagnosticFieldIdProperty = RuntimeProperty(
    "DiagnosticFieldId", str, default=REQUIRED, storage_name="diagnostic_field_id"
)
...
_DefaultFactoryInitActionSpec = RuntimeRecord(
    "DefaultFactoryInitAction",
    (
        _ActionIdProperty,
        _ActionOwnerProperty,
        _ActionFieldIdProperty,
        _ActionFieldNameProperty,
        _ActionFieldOrderProperty,
        _ActionKindProperty,
        _ActionEvalOrderProperty,
        _FactoryParamNamesProperty,
        _ActionDefaultFactoryParamNameProperty,
    ),
)
_DefaultFactoryDepSpec = RuntimeRecord(
    ...
    (
        ...
        _ProviderDefaultValueParamNameProperty,
        _ParamNameProperty,
        _ParamOrderProperty,
    ),
)
_InitEvaluationStepSpec = RuntimeRecord(
    "InitEvaluationStep",
    (
        _EvalStepIdProperty,
        _EvalOwnerProperty,
...
_ComputedClassDiagnosticSpec = RuntimeRecord(
...
_DataclassFieldSpecUnion = RuntimeUnion(
    "DataclassFieldSpec", (_InstanceFieldSpec, _InitVarFieldSpec, _ClassVarFieldSpec)
)
...
class DefaultFactoryInitAction:
    ...
    def __init__(
        ...
        *,
        ...
        if not isinstance(action_default_factory_param_name, str):
            raise TypeError(
                "ActionDefaultFactoryParamName must be str, got "
                + type(action_default_factory_param_name).__name__
            )
        object.__setattr__(
            self, "action_default_factory_param_name", action_default_factory_param_name
        )
    ...
    def __repr__(self):
        ...
        pieces.append(
            "action_default_factory_param_name="
            + repr(self.action_default_factory_param_name)
        )
...
class DefaultFactoryDep:
    __slots__ = (
        ...
        "provider_default_value_param_name",
        "param_name",
        "param_order",
    )
    ...
    def __init__(
        ...
        *,
        ...
        if not isinstance(provider_default_value_param_name, str):
            raise TypeError(
                "ProviderDefaultValueParamName must be str, got "
                + type(provider_default_value_param_name).__name__
            )
        object.__setattr__(
            self, "provider_default_value_param_name", provider_default_value_param_name
        )
    ...
    def __repr__(self):
        ...
        pieces.append(
            "provider_default_value_param_name="
            + repr(self.provider_default_value_param_name)
        )
...
FieldsCollection = RuntimeCollection(
    "Fields", _DataclassFieldSpecUnion, allows_multiple=True, identity=_FieldIdProperty
)
DefaultFactoryInitActionsCollection = RuntimeCollection(
    "DefaultFactoryInitActions",
    _DefaultFactoryInitActionSpec,
    allows_multiple=True,
    identity=_ActionIdProperty,
)
DefaultFactoryDepsCollection = RuntimeCollection(
    "DefaultFactoryDeps",
...
InitEvaluationStepsCollection = RuntimeCollection(
    "InitEvaluationSteps",
    _InitEvaluationStepSpec,
    allows_multiple=True,
    identity=_EvalStepIdProperty,
)
DiagnosticsCollection = RuntimeCollection(
    "Diagnostics",
    _ComputedClassDiagnosticSpec,
    allows_multiple=True,
    identity=_DiagnosticIdProperty,
)
InitDefaultFactoryGuardFieldsCollection = RuntimeComputedCollection(
    "InitDefaultFactoryGuardFields",
    source=FieldsCollection,
    when=(_InitProperty.eq(True), _HasDefaultFactoryProperty.eq(True)),
)
ZeroArgDefaultFactoryActionsCollection = RuntimeComputedCollection(
    "ZeroArgDefaultFactoryActions",
    source=DefaultFactoryInitActionsCollection,
    when=(_ActionKindProperty.eq("zero_arg"),),
)
ParameterizedDefaultFactoryActionsCollection = RuntimeComputedCollection(
    "ParameterizedDefaultFactoryActions",
    source=DefaultFactoryInitActionsCollection,
    when=(_ActionKindProperty.eq("parameterized"),),
)
_RUNTIME_SPEC = RuntimeContainerSpec(
    ...
    computed_collections=(
        InitDefaultFactoryGuardFieldsCollection,
        ZeroArgDefaultFactoryActionsCollection,
        ParameterizedDefaultFactoryActionsCollection,
    ),
    ports=(),
    port_index=None,
)
    ...
    for field in fields:
        if (
            ...
            add_diagnostic(
                field,
                "initvar",
                f"init-only field {field.field_name} with init=False must specify default or default_factory",
            )
...
def run_raise_computed_class_diagnostics(builder):
    ctx = DDSOperationContext(
        builder, "RaiseComputedClassDiagnostics", ordered_inputs={}
    )
...
ASSEMBLY_PROPERTIES = {
    ...
    "ActionId": _YidlSimpleNamespace(name="ActionId", storage_name="action_id"),
    "ActionOwner": _YidlSimpleNamespace(
        name="ActionOwner", storage_name="action_owner"
    ),
    "ActionFieldId": _YidlSimpleNamespace(
        name="ActionFieldId", storage_name="action_field_id"
    ),
    "ActionFieldName": _YidlSimpleNamespace(
        name="ActionFieldName", storage_name="action_field_name"
    ),
    "ActionFieldOrder": _YidlSimpleNamespace(
    ...
    "ActionDefaultFactoryParamName": _YidlSimpleNamespace(
        name="ActionDefaultFactoryParamName",
        storage_name="action_default_factory_param_name",
    ),
    ...
    "ProviderDefaultValueParamName": _YidlSimpleNamespace(
        name="ProviderDefaultValueParamName",
        storage_name="provider_default_value_param_name",
    ),
...
ASSEMBLY_CONTRIBUTIONS = {
    ...
    "ClassExport": ContributionSpec(
        name="ClassExport",
        source_name="ClassExportEntry",
        source_kind="resource",
        build_name="ClassExport",
        index=ValueRef("ClassOrder"),
        order=ValueRef("ClassOrder"),
        target=TargetSpec(
            name="class_exports",
    ...
    "FieldInfoDefaultContribution": ContributionSpec(
        name="FieldInfoDefaultContribution",
        source_name="FieldInfoDefaultEntry",
        source_kind="resource",
        build_name="FieldInfoEntry",
        index=ValueRef("FieldOrder"),
        order=ValueRef("FieldOrder"),
    ...
    "FieldInfoDefaultFactoryContribution": ContributionSpec(
        name="FieldInfoDefaultFactoryContribution",
        source_name="FieldInfoDefaultFactoryEntry",
        source_kind="resource",
        build_name="FieldInfoEntry",
        index=ValueRef("FieldOrder"),
        order=ValueRef("FieldOrder"),
    ...
    "DefaultAndFactoryDiagnostic": ContributionSpec(
        name="DefaultAndFactoryDiagnostic",
        source_name="DefaultAndFactoryDiagnosticMessage",
        source_kind="resource",
        build_name="DefaultAndFactoryDiagnostic",
        index=None,
        order=None,
        target=None,
        bindings=(
    ...
    "DefaultFactoryEvalContribution": ContributionSpec(
        ...
        bindings=(
            ...
            BindingSpec(
                kind="ident",
                name="default_factory_name",
                value=ValueRef("ActionDefaultFactoryParamName"),
            ),
        ),
    ),
    ...
    "DefaultFactoryDefaultArgContribution": ContributionSpec(
        ...
        bindings=(
            ...
            BindingSpec(
                kind="ident",
                name="default_value_name",
                value=ValueRef("ProviderDefaultValueParamName"),
            ),
        ),
    ),
}
ASSEMBLY_MATCHERS = {
    ...
    "ClassExportContribution": ContributionMatcherSpec(
        name="ClassExportContribution",
        inputs=(
            AssemblyInputSpec(
                name="facade", collection_name="Facades", collection=None
            ),
    ...
    "AnnotationContributions": ContributionMatcherSpec(
        ...
        rules=(
            ContributionRuleSpec(
                ...
                contribution_name="AnnotationContribution",
                weight=1.0,
            ),
            ContributionRuleSpec(
                name="classvar_annotation",
                condition=AndConditionSpec(
                    items=(
                        EqConditionSpec(
                            left=ValueRef("FieldOwner"), right=ValueRef("ClassId")
    ...
    "FieldInfoContributions": ContributionMatcherSpec(
        ...
        rules=(
            ContributionRuleSpec(
                ...
                contribution_name="FieldInfoDefaultContribution",
                weight=1.0,
            ),
            ContributionRuleSpec(
                name="default_factory",
                ...
                contribution_name="FieldInfoDefaultFactoryContribution",
                weight=1.0,
            ),
            ContributionRuleSpec(
                name="initvar_plain",
                ...
                contribution_name="FieldInfoContribution",
                weight=1.0,
            ),
            ContributionRuleSpec(
    ...
    "FieldDiagnostics": ContributionMatcherSpec(
        name="FieldDiagnostics",
        inputs=(
            AssemblyInputSpec(name="field", collection_name="Fields", collection=None),
            AssemblyInputSpec(
                name="facade", collection_name="Facades", collection=None
        ...
        rules=(
            ContributionRuleSpec(
                ...
                contribution_name="DefaultAndFactoryDiagnostic",
                weight=1.0,
            ),
        ),
    ),
...
ASSEMBLY_EDGES = {
    "ModuleProduction.diagnostics": AssemblyEdgeSpec(
        name="ModuleProduction.diagnostics",
        context_inputs=(),
        from_inputs=(
            AssemblyInputSpec(
                name="facade", collection_name="Facades", collection=None
    ...
    "ModuleProduction.exports": AssemblyEdgeSpec(
        name="ModuleProduction.exports",
        context_inputs=(),
        from_inputs=(
            AssemblyInputSpec(
                name="facade", collection_name="Facades", collection=None
        ...
        condition=None,
        matcher_name="ClassExportContribution",
    ),
