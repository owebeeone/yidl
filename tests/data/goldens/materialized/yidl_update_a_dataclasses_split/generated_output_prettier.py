...
def build_generated_dataclasses(
    *,
    _Widget_dataclass_params,
    _Widget_dataclass_fields,
    _Widget_annotations,
    _Widget_match_args,
    _Widget_level_default,
    _Widget_tags_default_factory,
    _Widget_scale_default,
    _Widget_hidden_default,
    _Widget_kind_default,
):
    ...
    class Widget:
        ...
        def __init__(
            self,
            count: "int",
            level: "int" = _Widget_level_default,
            tags: "list[str]" = _HAS_DEFAULT_FACTORY,
            scale: "int" = _Widget_scale_default,
        ):
            pass
            pass
