...
class Widget:
    ...
    __dataclass_fields__ = {'count': _field_info(name='count', type='int', default=None, default_factory=None, init=True, repr=True, compare=True, hash=None, kw_only=False, metadata=None, kind='field'), 'label': _field_info(name='label', type='str', default=None, default_factory=None, init=True, repr=True, compare=True, hash=None, kw_only=False, metadata=None, kind='field')}
    ...
    def __repr__(self):
        return 'Widget' + '(' + ', '.join(('count' + '=' + repr(getattr(self, 'count')), 'label' + '=' + repr(getattr(self, 'label')))) + ')'

    def __eq__(self, other):
        if other.__class__ is self.__class__:
            return (getattr(self, 'count'), getattr(self, 'label')) == (getattr(other, 'count'), getattr(other, 'label'))
