...
_LifecycleFieldSpecUnion = RuntimeUnion('LifecycleFieldSpec', (_PlainFieldSpec, _InitVarFieldSpec, _ClassVarFieldSpec, _ManagedFieldSpec))
...
class PlainField:
    __slots__ = ('field_id', 'field_owner', 'field_name', 'field_order', 'field_kind', 'annotation', 'init', 'has_default', 'default_value', 'default_value_param_name', 'has_default_factory', 'default_factory', 'default_factory_param_name', 'default_factory_param_names', 'tx_group_key', 'value_slot_name', 'current_slot_name', 'working_slot_name', 'staged_slot_name', 'has_freeze', 'freeze', 'freeze_param_name', 'has_thaw', 'thaw', 'thaw_param_name', 'has_optional_none')
    ...
    def __setattr__(self, name, value):
        if name in ('field_id', 'field_owner', 'field_name', 'field_order', 'field_kind', 'annotation', 'init', 'has_default', 'default_value', 'default_value_param_name', 'has_default_factory', 'default_factory', 'default_factory_param_name', 'default_factory_param_names', 'tx_group_key', 'value_slot_name', 'current_slot_name', 'working_slot_name', 'staged_slot_name', 'has_freeze', 'freeze', 'freeze_param_name', 'has_thaw', 'thaw', 'thaw_param_name', 'has_optional_none'):
...
def build_lifecycle_class(decorated_cls, builder_params__astichi_param_hole__):
    ...
    astichi_hole(return_statement)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=205), 'BuilderParam': astichi_template(from_astichi_code("""\
def astichi_params(*, value_name__astichi_arg__):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=223)), 'TransactionManagerParam': astichi_template(from_astichi_code("""\
def astichi_params(*, transaction_manager=None):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=228)), 'StateSlotEntry': astichi_template(from_astichi_code('astichi_bind_external(slot_name)', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=233)), 'InitParamRequired': astichi_template(from_astichi_code("""\
def astichi_params(param_name__astichi_arg__: astichi_bind_external(annotation)):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=237)), 'InitParamDefault': astichi_template(from_astichi_code("""\
def astichi_params(
    param_name__astichi_arg__: astichi_bind_external(annotation)
    = default_value_name__astichi_arg__
):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=242)), 'PlainStateAssignment': astichi_template(from_astichi_code("""\
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = astichi_pass(
    init_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=250)), 'InitVarLocalDefaultAssignment': astichi_template(from_astichi_code("""\
init_value_name__astichi_arg__ = astichi_pass(
    default_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=257)), 'PlainProperty': astichi_template(from_astichi_code("""\
@property
...
def property_setter_name__astichi_arg__(self, value):
    self._y_state.astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=264)), 'ClassVarDefaultAssignment': astichi_template(from_astichi_code("""\
classvar_name__astichi_arg__ = astichi_pass(
    classvar_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=274)), 'CommitOrderKeyBranch': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    return astichi_pass(
        self,
        outer_bind=True,
    )._y_get_default_facade().astichi_ref(external=method_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=281)), 'RequiresValidationBranch': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    return True""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=289)), 'ValidateCommitBranch': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    result = astichi_pass(
        self,
        outer_bind=True,
    ...
    if result is False:
        return False""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=294)), 'TransactionHookCall': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    astichi_pass(
        self,
        outer_bind=True,
    )._y_get_default_facade().astichi_ref(external=method_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=304)), 'ClassBundle': astichi_template(from_astichi_code("""\
...
class working_facade_class_decl_name__astichi_arg__(
    ...
    __slots__ = ()
    astichi_hole(working_facade_properties)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=312, keep_names=('DEFAULT_TRANSACTION', 'TransactionManager', 'VOID', 'weakref', '_HAS_DEFAULT_FACTORY'))), 'ReturnClass': astichi_template(from_astichi_code("""\
...
return return_class_result_ref__astichi_arg__""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=611)), 'PassStatement': astichi_template(from_astichi_code('pass', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=627)), 'BuildTransactionFactsBody': from_astichi_code("""\
from yidl.runtime.transaction_yidl import DEFAULT_TRANSACTION
...
if result is False:
    return False""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=428)), 'TransactionHookHelperCall': astichi_template(from_astichi_code("""\
astichi_pass(
    self,
    outer_bind=True,
...
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    return astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=requires_validation_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=452)), 'ValidateCommitDispatchCall': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    return astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=validate_commit_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=460)), 'BeforeCommitDispatchCall': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=before_commit_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=468)), 'AfterCommitDispatchCall': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=after_commit_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=476)), 'AfterRollbackDispatchCall': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=after_rollback_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=484)), 'PrepareCommitFieldsFunction': astichi_template(from_astichi_code("""\
def prepare_commit_fields_function_name__astichi_arg__(self):
    astichi_hole(prepare_commit_fields_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=492)), 'ApplyPreparedCommitFieldsFunction': astichi_template(from_astichi_code("""\
def apply_prepared_commit_fields_function_name__astichi_arg__(self):
    astichi_hole(apply_prepared_commit_fields_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=497)), 'RollbackFieldsFunction': astichi_template(from_astichi_code("""\
def rollback_fields_function_name__astichi_arg__(self):
    astichi_hole(rollback_fields_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=502)), 'ApplyPreparedCommitDispatchBranch': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=apply_prepared_commit_fields_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=507)), 'PrepareCommitDispatchBranch': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=prepare_commit_fields_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=515)), 'RollbackDispatchBranch': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=rollback_fields_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=523)), 'BuildDefaultFactoryFactsBody': from_astichi_code("""\
classes = sorted(
    ctx.records(ClassesCollection),
    key=lambda item: item.class_order,
)
...
for diagnostic in ctx.records(DefaultFactoryDiagnosticsCollection):
    raise AssemblyDiagnosticError(diagnostic.diagnostic_message)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=270, keep_names=('ctx', 'DefaultFactoryDiagnosticsCollection', 'AssemblyDiagnosticError')), 'InitParamDefaultFactory': astichi_template(from_astichi_code("""\
def astichi_params(
    param_name__astichi_arg__: astichi_bind_external(annotation)
    = _HAS_DEFAULT_FACTORY
):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=286, keep_names=('_HAS_DEFAULT_FACTORY',))), 'StoredDefaultFactoryEvalInit': astichi_template(from_astichi_code("""\
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = astichi_pass(
    ...
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=296, keep_names=('_HAS_DEFAULT_FACTORY',))), 'StoredDefaultFactoryEvalNoInit': astichi_template(from_astichi_code("""\
