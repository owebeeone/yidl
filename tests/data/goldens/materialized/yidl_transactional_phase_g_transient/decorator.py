...
_LocalStoreFieldSpec = RuntimeRecord('LocalStoreField', (_FieldIdProperty, _FieldOwnerProperty, _FieldNameProperty, _FieldOrderProperty, _FieldKindProperty, _BindingShapeProperty, _AnnotationProperty, _InitProperty, _HasDefaultProperty, _DefaultValueProperty, _DefaultValueParamNameProperty, _HasDefaultFactoryProperty, _DefaultFactoryProperty, _AllowSelfFactoryProperty, _DefaultFactoryParamNameProperty, _DefaultFactoryParamNamesProperty, _HasWorkingDefaultFactoryProperty, _WorkingDefaultFactoryProperty, _WorkingDefaultFactoryParamNameProperty, _WorkingDefaultFactoryParamNamesProperty, _TxKeyKeyProperty, _ValueSlotNameProperty, _CurrentSlotNameProperty, _WorkingSlotNameProperty, _StagedSlotNameProperty, _HasFreezeProperty, _FreezeProperty, _FreezeParamNameProperty, _HasThawProperty, _ThawProperty, _ThawParamNameProperty, _HasOptionalNoneProperty))
...
class PlainField:
    __slots__ = ('field_id', 'field_owner', 'field_name', 'field_order', 'field_kind', 'binding_shape', 'annotation', 'init', 'has_default', 'default_value', 'default_value_param_name', 'has_default_factory', 'default_factory', 'allow_self_factory', 'default_factory_param_name', 'default_factory_param_names', 'has_working_default_factory', 'working_default_factory', 'working_default_factory_param_name', 'working_default_factory_param_names', 'tx_key_key', 'value_slot_name', 'current_slot_name', 'working_slot_name', 'staged_slot_name', 'has_freeze', 'freeze', 'freeze_param_name', 'has_thaw', 'thaw', 'thaw_param_name', 'has_optional_none')
    ...
    def __setattr__(self, name, value):
        if name in ('field_id', 'field_owner', 'field_name', 'field_order', 'field_kind', 'binding_shape', 'annotation', 'init', 'has_default', 'default_value', 'default_value_param_name', 'has_default_factory', 'default_factory', 'allow_self_factory', 'default_factory_param_name', 'default_factory_param_names', 'has_working_default_factory', 'working_default_factory', 'working_default_factory_param_name', 'working_default_factory_param_names', 'tx_key_key', 'value_slot_name', 'current_slot_name', 'working_slot_name', 'staged_slot_name', 'has_freeze', 'freeze', 'freeze_param_name', 'has_thaw', 'thaw', 'thaw_param_name', 'has_optional_none'):
...
def build_lifecycle_class(decorated_cls, builder_params__astichi_param_hole__):
    ...
    astichi_hole(return_statement)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=215), 'BuilderParam': astichi_template(from_astichi_code("""\
def astichi_params(*, value_name__astichi_arg__):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=233)), 'TransactionManagerParam': astichi_template(from_astichi_code("""\
def astichi_params(*, transaction_manager=None):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=238)), 'StateSlotEntry': astichi_template(from_astichi_code('astichi_bind_external(slot_name)', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=243)), 'InitParamRequired': astichi_template(from_astichi_code("""\
def astichi_params(param_name__astichi_arg__: astichi_bind_external(annotation)):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=247)), 'InitParamDefault': astichi_template(from_astichi_code("""\
def astichi_params(
    param_name__astichi_arg__: astichi_bind_external(annotation)
    = default_value_name__astichi_arg__
):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=252)), 'PlainStateAssignment': astichi_template(from_astichi_code("""\
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = astichi_pass(
    init_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=260)), 'InitVarLocalDefaultAssignment': astichi_template(from_astichi_code("""\
init_value_name__astichi_arg__ = astichi_pass(
    default_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=267)), 'PlainProperty': astichi_template(from_astichi_code("""\
@property
...
def property_setter_name__astichi_arg__(self, value):
    self._y_state.astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=274)), 'ClassVarDefaultAssignment': astichi_template(from_astichi_code("""\
classvar_name__astichi_arg__ = astichi_pass(
    classvar_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=284)), 'CommitOrderKeyBranch': astichi_template(from_astichi_code("""\
def astichi_elif():
    astichi_import(tx_index)
    astichi_import(self)

    if tx_index == astichi_bind_external(tx_index_value):
        return self._y_get_default_facade().astichi_ref(external=method_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=291)), 'RequiresValidationBranch': astichi_template(from_astichi_code("""\
def astichi_elif():
    astichi_import(tx_index)

    if tx_index == astichi_bind_external(tx_index_value):
        return True""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=300)), 'ValidateCommitBranch': astichi_template(from_astichi_code("""\
def astichi_elif():
    astichi_import(tx_index)
    astichi_import(self)
    ...
    if tx_index == astichi_bind_external(tx_index_value):
        ...
        if result is False:
            return False""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=308)), 'TransactionHookCall': astichi_template(from_astichi_code("""\
def astichi_elif():
    astichi_import(tx_index)
    astichi_import(self)

    if tx_index == astichi_bind_external(tx_index_value):
        self._y_get_default_facade().astichi_ref(external=method_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=319)), 'CommitOrderKeyFallbackBranch': astichi_template(from_astichi_code("""\
def astichi_elif():
    if True:
        return ()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=328)), 'RequiresValidationFallbackBranch': astichi_template(from_astichi_code("""\
def astichi_elif():
    if True:
        return False""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=334)), 'ValidateCommitFallbackBranch': astichi_template(from_astichi_code("""\
def astichi_elif():
    if True:
        return True""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=340)), 'PassFallbackBranch': astichi_template(from_astichi_code("""\
def astichi_elif():
    if True:
        pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=346)), 'ClassBundle': astichi_template(from_astichi_code("""\
...
class working_facade_class_decl_name__astichi_arg__(
    ...
    with astichi_hole(working_facade_properties) as astichi_fallback:
        pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=352, keep_names=('DEFAULT_TRANSACTION', 'TransactionManager', 'VOID', 'weakref', '_HAS_DEFAULT_FACTORY'))), 'ReturnClass': astichi_template(from_astichi_code("""\
