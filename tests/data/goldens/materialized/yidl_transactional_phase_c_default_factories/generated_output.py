...
def build_lifecycle_class(decorated_cls, *, _Example_lifecycle_definition, _Example_annotations, _Example_tx_groups, _Example_SCALE_default, _Example_seed_default, _Example_temp_default_factory, _Example_v2_default_factory, _Example_v3_default_factory, _Example_v4_default_factory, _Example_v5_default_factory):
    ...
    class Example_State:
        __slots__ = ('_y_transaction_manager', '_y_default_ref', '_y_current_ref', '_y_working_ref', '_y_v1_value', '_y_v2_current', '_y_v2_working', '_y_v3_current', '_y_v3_working', '_y_v4_current', '_y_v4_working', '_y_v5_current', '_y_v5_working', '_y_working_tx_ids')
        __yidl_tx_index_to_group__ = _Example_tx_groups
        __yidl_tx_group_to_index__ = {group: index for index, group in enumerate(_Example_tx_groups)}
