...
def build_lifecycle_class(decorated_cls, builder_params__astichi_param_hole__):
    ...
    astichi_hole(return_statement)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=171), 'BuilderParam': astichi_template(from_astichi_code("""\
def astichi_params(*, value_name__astichi_arg__):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=189)), 'TransactionManagerParam': astichi_template(from_astichi_code("""\
def astichi_params(*, transaction_manager=None):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=194)), 'StateSlotEntry': astichi_template(from_astichi_code('astichi_bind_external(slot_name)', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=199)), 'InitParamRequired': astichi_template(from_astichi_code("""\
def astichi_params(param_name__astichi_arg__: astichi_bind_external(annotation)):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=203)), 'InitParamDefault': astichi_template(from_astichi_code("""\
def astichi_params(
    param_name__astichi_arg__: astichi_bind_external(annotation)
    = default_value_name__astichi_arg__
):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=208)), 'PlainStateAssignment': astichi_template(from_astichi_code("""\
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = astichi_pass(
    init_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=216)), 'InitVarLocalDefaultAssignment': astichi_template(from_astichi_code("""\
init_value_name__astichi_arg__ = astichi_pass(
    default_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=223)), 'PlainProperty': astichi_template(from_astichi_code("""\
@property
...
def property_setter_name__astichi_arg__(self, value):
    self._y_state.astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=230)), 'ClassVarDefaultAssignment': astichi_template(from_astichi_code("""\
classvar_name__astichi_arg__ = astichi_pass(
    classvar_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=240)), 'ClassBundle': astichi_template(from_astichi_code("""\
...
class working_facade_class_decl_name__astichi_arg__(
    ...
    __slots__ = ()
    astichi_hole(working_facade_properties)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=247, keep_names=('DEFAULT_TRANSACTION', 'TransactionManager', 'VOID', 'weakref', '_HAS_DEFAULT_FACTORY'))), 'ReturnClass': astichi_template(from_astichi_code("""\
...
return return_class_result_ref__astichi_arg__""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=485)), 'PassStatement': astichi_template(from_astichi_code('pass', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=501)), 'BuildTransactionFactsBody': from_astichi_code("""\
from yidl.runtime.transaction_yidl import DEFAULT_TRANSACTION
