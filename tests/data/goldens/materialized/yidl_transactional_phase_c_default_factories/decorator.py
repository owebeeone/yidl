...
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_const_static.yidl', line_number=148)), 'StaticDefaultFactoryEmptyArg': astichi_template(from_astichi_code('astichi_funcargs()', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_const_static.yidl', line_number=157))}
