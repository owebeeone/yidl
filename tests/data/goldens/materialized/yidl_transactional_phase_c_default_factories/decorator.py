...
_LifecycleFieldSpecUnion = RuntimeUnion('LifecycleFieldSpec', (_PlainFieldSpec, _InitVarFieldSpec, _ClassVarFieldSpec, _ManagedFieldSpec, _TransientFieldSpec))
...
for diagnostic in ctx.records(DefaultFactoryDiagnosticsCollection):
    raise AssemblyDiagnosticError(diagnostic.diagnostic_message)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=272, keep_names=('ctx', 'DefaultFactoryDiagnosticsCollection', 'AssemblyDiagnosticError')), 'InitParamDefaultFactory': astichi_template(from_astichi_code("""\
def astichi_params(
    param_name__astichi_arg__: astichi_bind_external(annotation)
    = _HAS_DEFAULT_FACTORY
):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=288, keep_names=('_HAS_DEFAULT_FACTORY',))), 'StoredDefaultFactoryEvalInit': astichi_template(from_astichi_code("""\
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = astichi_pass(
    ...
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=298, keep_names=('_HAS_DEFAULT_FACTORY',))), 'StoredDefaultFactoryEvalNoInit': astichi_template(from_astichi_code("""\
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = astichi_pass(
    field_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=313)), 'InitVarDefaultFactoryEvalInit': astichi_template(from_astichi_code("""\
if astichi_pass(field_name__astichi_arg__, outer_bind=True) is _HAS_DEFAULT_FACTORY:
    astichi_pass(field_name__astichi_arg__, outer_bind=True)._ = (
        default_factory_name__astichi_arg__(
            **astichi_hole(default_factory_args)
        )
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=323, keep_names=('_HAS_DEFAULT_FACTORY',))), 'InitVarDefaultFactoryEvalNoInit': astichi_template(from_astichi_code("""\
field_name__astichi_arg__ = default_factory_name__astichi_arg__(
    **astichi_hole(default_factory_args)
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=334)), 'DefaultFactoryStoredArg': astichi_template(from_astichi_code("""\
astichi_funcargs(
    param_name__astichi_arg__=astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=provider_name)
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=340)), 'DefaultFactoryLocalArg': astichi_template(from_astichi_code("""\
astichi_funcargs(
    param_name__astichi_arg__=astichi_pass(
        provider_name__astichi_arg__,
        outer_bind=True,
    )
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=349)), 'BuildTransientFactsBody': from_astichi_code("""\
from yidl.runtime.transaction_yidl import DEFAULT_TRANSACTION
