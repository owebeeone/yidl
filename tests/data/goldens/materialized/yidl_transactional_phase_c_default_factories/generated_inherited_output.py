...
def build_lifecycle_class(decorated_cls, *, _Derived_lifecycle_definition, _Derived_annotations, _Derived_tx_groups, _Derived_v1_default, _Derived_v2_default_factory):
    ...
    class Derived_State:
        __slots__ = ('_y_transaction_manager', '_y_default_ref', '_y_current_ref', '_y_working_ref', '_y_v1_current', '_y_v1_working', '_y_v2_current', '_y_v2_working', '_y_working_tx_ids')
        __yidl_tx_index_to_group__ = _Derived_tx_groups
        __yidl_tx_group_to_index__ = {group: index for index, group in enumerate(_Derived_tx_groups)}
