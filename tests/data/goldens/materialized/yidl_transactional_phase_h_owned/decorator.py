...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=130)), 'OwnedEmptyStateAssignment': astichi_template(from_astichi_code('astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = VOID', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=155, keep_names=('VOID',))), 'OwnedDefaultProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
    if state.astichi_ref(external=working_slot) is not VOID:
...
def property_setter_name__astichi_arg__(self, value):
    ...
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=161, keep_names=('VOID',))), 'OwnedMapDefaultProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
    if state.astichi_ref(external=working_slot) is not VOID:
...
def property_setter_name__astichi_arg__(self, value):
    ...
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=180, keep_names=('VOID',))), 'OwnedCurrentProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    return self._y_state.astichi_ref(external=current_slot)
...
def property_setter_name__astichi_arg__(self, value):
    ...
    raise AttributeError(
        ...
        + astichi_bind_external(field_name)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=199)), 'OwnedWorkingProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
    if state.astichi_ref(external=working_slot) is not VOID:
...
def property_setter_name__astichi_arg__(self, value):
    ...
    state.astichi_ref(external=working_slot)._ = (
        _y_validate_binding_value(astichi_bind_external(field_name), value)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=213, keep_names=('VOID',))), 'OwnedMapWorkingProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
    if state.astichi_ref(external=working_slot) is not VOID:
...
def property_setter_name__astichi_arg__(self, value):
    ...
    state.astichi_ref(external=working_slot)._ = (
        _y_validate_binding_map_value(astichi_bind_external(field_name), value)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=232, keep_names=('VOID',))), 'OwnedPrepareCommitBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot) is not VOID:
    value = astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)
    if value is not None:
        value.accepted()
    astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=251, keep_names=('VOID',))), 'OwnedMapPrepareCommitBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot) is not VOID:
    value = astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)
    if value is not None:
        for item in value.values():
            item.accepted()
    astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=261, keep_names=('VOID',))), 'OwnedScalarDefaultFactoryEvalInit': astichi_template(from_astichi_code("""\
astichi_pyimport(module=yidl.runtime.bindings, names=(BindingBase,))
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=272, keep_names=('_HAS_DEFAULT_FACTORY',))), 'OwnedScalarDefaultFactoryEvalNoInit': astichi_template(from_astichi_code("""\
astichi_pyimport(module=yidl.runtime.bindings, names=(BindingBase,))
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=292)), 'OwnedMapDefaultFactoryEvalInit': astichi_template(from_astichi_code("""\
astichi_pyimport(module=collections.abc, names=(Mapping,))
astichi_pyimport(module=yidl.runtime.bindings, names=(BindingBase, BindingDict,))
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=307, keep_names=('_HAS_DEFAULT_FACTORY',))), 'OwnedMapDefaultFactoryEvalNoInit': astichi_template(from_astichi_code("""\
astichi_pyimport(module=collections.abc, names=(Mapping,))
astichi_pyimport(module=yidl.runtime.bindings, names=(BindingBase, BindingDict,))
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=340)), 'OwnedApplyPreparedCommitBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot) is not VOID:
    astichi_pass(self, outer_bind=True).astichi_ref(external=current_slot)._ = (
        astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)
    )
    astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = VOID
    astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)._ = VOID""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=368, keep_names=('VOID',))), 'OwnedRollbackBranch': astichi_template(from_astichi_code("""\
astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = VOID
astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)._ = VOID""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=379, keep_names=('VOID',))), 'BindingStateAssignment': astichi_template(from_astichi_code("""\
astichi_pyimport(module=yidl.runtime.bindings, names=(BindingBase,))
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=386)), 'BindingMapStateAssignment': astichi_template(from_astichi_code("""\
astichi_pyimport(module=collections.abc, names=(Mapping,))
astichi_pyimport(module=yidl.runtime.bindings, names=(BindingBase, BindingDict,))
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=398)), 'BindingProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    return self._y_state.astichi_ref(external=state_slot)
...
def property_setter_name__astichi_arg__(self, value):
    self._y_state.astichi_ref(external=state_slot)._ = (
        _y_validate_binding_value(astichi_bind_external(field_name), value)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=423)), 'BindingMapProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    return self._y_state.astichi_ref(external=state_slot)
...
def property_setter_name__astichi_arg__(self, value):
    self._y_state.astichi_ref(external=state_slot)._ = (
        _y_validate_binding_map_value(astichi_bind_external(field_name), value)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=435)), 'BindingDefaultFactoryEvalInit': astichi_template(from_astichi_code("""\
if astichi_pass(field_name__astichi_arg__, outer_bind=True) is _HAS_DEFAULT_FACTORY:
    astichi_pass(field_name__astichi_arg__, outer_bind=True)._ = (
        default_factory_name__astichi_arg__(
            **astichi_hole(default_factory_args)
...
astichi_pass(self, outer_bind=True).astichi_ref(external=property_name)._ = astichi_pass(
    field_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=447, keep_names=('_HAS_DEFAULT_FACTORY',))), 'BindingDefaultFactoryEvalNoInit': astichi_template(from_astichi_code("""\
field_name__astichi_arg__ = default_factory_name__astichi_arg__(
    **astichi_hole(default_factory_args)
)
astichi_pass(self, outer_bind=True).astichi_ref(external=property_name)._ = astichi_pass(
    field_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=462))}
