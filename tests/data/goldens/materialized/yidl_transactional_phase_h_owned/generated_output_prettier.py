    ...
    *,
    ...
    class Owner_FacadeBase(decorated_cls):
        ...
        def handles(self, value):
            self._y_state._y_handles_value = _y_validate_binding_map_value(
                "handles", value
            )
    ...
    class Owner(Owner_FacadeBase):
        ...
        def __init__(
            ...
            *,
            ...
            if value is not None and (not isinstance(value, BindingBase)):
                raise TypeError(
                    "binding field " + repr("child") + " expects BindingBase or None"
                )
            ...
            if value__astichi_scoped_2 is not None and (
                not isinstance(value__astichi_scoped_2, BindingBase)
            ):
                raise TypeError(
                    "binding field " + repr("handle") + " expects BindingBase or None"
                )
            ...
            if value__astichi_scoped_3 is not None and (
                not isinstance(value__astichi_scoped_3, Mapping)
            ):
                raise TypeError(
                    "binding map field "
                    + repr("children")
            ...
            if value__astichi_scoped_3 is not None:
                value__astichi_scoped_3 = (
                    value__astichi_scoped_3
                    if isinstance(value__astichi_scoped_3, BindingDict)
                    else BindingDict(value__astichi_scoped_3)
                )
    ...
    class Owner_Current(Owner_FacadeBase):
        ...
        def children(self, value):
            del value
            raise AttributeError(
                "current facade is read-only for owned field " + "children"
            )
