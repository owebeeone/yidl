...
_RUNTIME_SPEC = RuntimeContainerSpec(collections=(ClassesCollection, FieldsCollection, FacadeClassesCollection, FacadeExposuresCollection, InitParametersCollection, InitAssignmentsCollection, ClassVarAssignmentsCollection), computed_collections=(PlainFieldsCollection, InitVarFieldsCollection, ClassVarFieldsCollection), ports=(), port_index=None)
...
return return_class_result_ref__astichi_arg__""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=456)), 'PassStatement': astichi_template(from_astichi_code('pass', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=472))}
