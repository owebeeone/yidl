...
def build_lifecycle_class(decorated_cls, *, _Counter_lifecycle_definition, _Counter_annotations, _Counter_tx_keys, _Counter_plain_default, _Counter_seed_default, _Counter_KIND_default):
