...
class PlainField:
    __slots__ = ('field_id', 'field_owner', 'field_name', 'field_order', 'field_kind', 'annotation', 'init', 'has_default', 'default_value', 'default_value_param_name', 'has_default_factory', 'default_factory', 'default_factory_param_name', 'tx_group_key')
    ...
    def __setattr__(self, name, value):
        if name in ('field_id', 'field_owner', 'field_name', 'field_order', 'field_kind', 'annotation', 'init', 'has_default', 'default_value', 'default_value_param_name', 'has_default_factory', 'default_factory', 'default_factory_param_name', 'tx_group_key'):
...
_RUNTIME_SPEC = RuntimeContainerSpec(collections=(ClassesCollection, FieldsCollection, FacadeClassesCollection, FacadeExposuresCollection, TransactionalFieldsCollection, TxGroupsCollection, IndexedTransactionalFieldsCollection, InitParametersCollection, InitAssignmentsCollection, ClassVarAssignmentsCollection), computed_collections=(), ports=(), port_index=None)
...
for lifecycle_class in classes:
    ...
    for field in fields:
        ...
        ctx.write(
            ...
            policy=RejectDuplicate,
        )""", file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=144, keep_names=('ctx', 'ClassesCollection', 'FieldsCollection', 'TxGroupsCollection', 'TransactionalFieldsCollection', 'IndexedTransactionalFieldsCollection', 'TxGroup', 'TransactionalField', 'IndexedTransactionalField', 'RejectDuplicate')), 'ModuleRoot': from_astichi_code("""\
...
def build_lifecycle_class(decorated_cls, builder_params__astichi_param_hole__):
    ...
    astichi_hole(return_statement)""", file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=282), 'BuilderParam': astichi_template(from_astichi_code("""\
def astichi_params(*, value_name__astichi_arg__):
    pass""", file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=299)), 'ClassBundle': astichi_template(from_astichi_code("""\
...
class working_facade_class_decl_name__astichi_arg__(
    ...
    __slots__ = ()""", file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=304, keep_names=('DEFAULT_TRANSACTION', 'TransactionManager', 'weakref'))), 'ReturnClass': astichi_template(from_astichi_code("""\
