...
_IndexedTransactionalFieldSpec = RuntimeRecord('IndexedTransactionalField', (_FieldIdProperty, _FieldOwnerProperty, _FieldNameProperty, _FieldOrderProperty, _TxGroupKeyProperty, _TxIndexProperty))
...
class IndexedTransactionalField:
    __slots__ = ('field_id', 'field_owner', 'field_name', 'field_order', 'tx_group_key', 'tx_index')
    ...
    def __init__(self, *, field_id: str, field_owner: str, field_name: str, field_order: int, tx_group_key: object=None, tx_index: int=0):
        if not isinstance(field_id, str):
            raise TypeError('FieldId must be str, got ' + type(field_id).__name__)
        object.__setattr__(self, 'field_id', field_id)
        if not isinstance(field_owner, str):
    ...
    def __setattr__(self, name, value):
        if name in ('field_id', 'field_owner', 'field_name', 'field_order', 'tx_group_key', 'tx_index'):
...
class PlainField:
    __slots__ = ('field_id', 'field_owner', 'field_name', 'field_order', 'field_kind', 'annotation', 'init', 'has_default', 'default_value', 'default_value_param_name', 'has_default_factory', 'default_factory', 'default_factory_param_name', 'tx_group_key', 'value_slot_name')
    ...
    def __setattr__(self, name, value):
        if name in ('field_id', 'field_owner', 'field_name', 'field_order', 'field_kind', 'annotation', 'init', 'has_default', 'default_value', 'default_value_param_name', 'has_default_factory', 'default_factory', 'default_factory_param_name', 'tx_group_key', 'value_slot_name'):
...
def run_build_transaction_facts(builder):
    ...
    for lifecycle_class in classes:
        ...
        for field in fields:
            ...
            ctx.write(IndexedTransactionalFieldsCollection, IndexedTransactionalField(field_id=field.field_id, field_owner=field.field_owner, field_name=field.field_name, field_order=field.field_order, tx_group_key=tx_group, tx_index=tx_index), policy=RejectDuplicate)
...
for lifecycle_class in classes:
    ...
    for field in fields:
        ...
        ctx.write(
            ...
            policy=RejectDuplicate,
        )""", file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=148, keep_names=('ctx', 'ClassesCollection', 'FieldsCollection', 'TxGroupsCollection', 'TransactionalFieldsCollection', 'IndexedTransactionalFieldsCollection', 'TxGroup', 'TransactionalField', 'IndexedTransactionalField', 'RejectDuplicate')), 'ModuleRoot': from_astichi_code("""\
...
def build_lifecycle_class(decorated_cls, builder_params__astichi_param_hole__):
    ...
    astichi_hole(return_statement)""", file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=286), 'BuilderParam': astichi_template(from_astichi_code("""\
def astichi_params(*, value_name__astichi_arg__):
    pass""", file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=303)), 'TransactionManagerParam': astichi_template(from_astichi_code("""\
def astichi_params(*, transaction_manager=None):
    pass""", file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=308)), 'StateSlotEntry': astichi_template(from_astichi_code('astichi_bind_external(slot_name)', file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=313)), 'InitParamRequired': astichi_template(from_astichi_code("""\
def astichi_params(param_name__astichi_arg__: astichi_bind_external(annotation)):
    pass""", file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=317)), 'InitParamDefault': astichi_template(from_astichi_code("""\
def astichi_params(
    param_name__astichi_arg__: astichi_bind_external(annotation)
    = default_value_name__astichi_arg__
):
    pass""", file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=322)), 'PlainStateAssignment': astichi_template(from_astichi_code("""\
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = astichi_pass(
    init_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=330)), 'PlainProperty': astichi_template(from_astichi_code("""\
@property
...
def property_setter_name__astichi_arg__(self, value):
    self._y_state.astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=337)), 'ClassVarDefaultAssignment': astichi_template(from_astichi_code("""\
classvar_name__astichi_arg__ = astichi_pass(
    classvar_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=347)), 'ClassBundle': astichi_template(from_astichi_code("""\
...
class working_facade_class_decl_name__astichi_arg__(
    ...
    __slots__ = ()""", file_name='tests/data/yidl/yidl_transactional_phase_a_base/lifecycle_base.yidl', line_number=354, keep_names=('DEFAULT_TRANSACTION', 'TransactionManager', 'weakref'))), 'ReturnClass': astichi_template(from_astichi_code("""\
