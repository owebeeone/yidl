...
astichi_pass(state, outer_bind=True).astichi_ref(external=current_slot)._ = astichi_pass(
    init_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=209)), 'ManagedWorkingStateAssignment': astichi_template(from_astichi_code('astichi_pass(state, outer_bind=True).astichi_ref(external=working_slot)._ = VOID', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=216, keep_names=('VOID',))), 'ManagedStagedStateAssignment': astichi_template(from_astichi_code('astichi_pass(state, outer_bind=True).astichi_ref(external=staged_slot)._ = VOID', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=222, keep_names=('VOID',))), 'ManagedDefaultProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
...
def property_setter_name__astichi_arg__(self, value):
    ...
    state.astichi_ref(external=working_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=228, keep_names=('VOID',))), 'ManagedCurrentProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
...
def property_setter_name__astichi_arg__(self, value):
    ...
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=245)), 'ManagedWorkingProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
    if state.astichi_ref(external=working_slot) is not VOID:
...
def property_setter_name__astichi_arg__(self, value):
    state = self._y_state
    state._y_ensure_working_transaction(astichi_bind_external(tx_index))
    state.astichi_ref(external=working_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=259, keep_names=('VOID',))), 'ManagedThawWorkingProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
    if state.astichi_ref(external=working_slot) is not VOID:
...
def property_setter_name__astichi_arg__(self, value):
    state = self._y_state
    state._y_ensure_working_transaction(astichi_bind_external(working_tx_index))
    state.astichi_ref(external=working_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=276, keep_names=('VOID',))), 'ManagedOptionalThawWorkingProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
    if state.astichi_ref(external=working_slot) is not VOID:
...
def property_setter_name__astichi_arg__(self, value):
    state = self._y_state
    state._y_ensure_working_transaction(astichi_bind_external(working_tx_index))
    state.astichi_ref(external=working_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=303, keep_names=('VOID',))), 'ManagedPlainPrepareBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot) is not VOID:
    ...
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=333, keep_names=('VOID',))), 'ManagedFreezePrepareBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot) is not VOID:
    astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = (
        freeze_func_name__astichi_arg__(
            astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)
        )
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=342, keep_names=('VOID',))), 'ManagedOptionalFreezePrepareBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot) is not VOID:
    astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = (
        None
    ...
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=353, keep_names=('VOID',))), 'ManagedApplyPreparedCommitBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot) is not VOID:
    ...
    astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)._ = VOID""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=366, keep_names=('VOID',))), 'ManagedRollbackBranch': astichi_template(from_astichi_code("""\
astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = VOID
astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)._ = VOID""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=377, keep_names=('VOID',))), 'CommitOrderKeyFunction': astichi_template(from_astichi_code("""\
def commit_order_key_function_name__astichi_arg__(self):
    astichi_hole(commit_order_key_tx_body)
    return ()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=384)), 'RequiresValidationFunction': astichi_template(from_astichi_code("""\
def requires_validation_function_name__astichi_arg__(self):
    astichi_hole(requires_validation_tx_body)
    return False""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=390)), 'ValidateCommitFunction': astichi_template(from_astichi_code("""\
def validate_commit_function_name__astichi_arg__(self):
    astichi_hole(validate_commit_tx_body)
    return True""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=396)), 'BeforeCommitFunction': astichi_template(from_astichi_code("""\
def before_commit_function_name__astichi_arg__(self):
    astichi_hole(before_commit_tx_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=402)), 'AfterCommitFunction': astichi_template(from_astichi_code("""\
def after_commit_function_name__astichi_arg__(self):
    astichi_hole(after_commit_tx_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=407)), 'AfterRollbackFunction': astichi_template(from_astichi_code("""\
def after_rollback_function_name__astichi_arg__(self):
    astichi_hole(after_rollback_tx_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=412)), 'CommitOrderKeyHelperCall': astichi_template(from_astichi_code("""\
return astichi_pass(
    self,
    outer_bind=True,
)._y_get_default_facade().astichi_ref(external=method_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=417)), 'RequiresValidationHelperCall': astichi_template(from_astichi_code('return True', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=424)), 'ValidateCommitHelperCall': astichi_template(from_astichi_code("""\
result = astichi_pass(
    self,
    outer_bind=True,
)._y_get_default_facade().astichi_ref(external=method_name)()
if not result:
    return result""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=428)), 'TransactionHookHelperCall': astichi_template(from_astichi_code("""\
astichi_pass(
    self,
    outer_bind=True,
)._y_get_default_facade().astichi_ref(external=method_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=437)), 'CommitOrderKeyDispatchCall': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        return astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=commit_order_key_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=444)), 'RequiresValidationDispatchCall': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        return astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=requires_validation_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=453)), 'ValidateCommitDispatchCall': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        return astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=validate_commit_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=462)), 'BeforeCommitDispatchCall': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=before_commit_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=471)), 'AfterCommitDispatchCall': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=after_commit_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=480)), 'AfterRollbackDispatchCall': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=after_rollback_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=489)), 'PrepareCommitFieldsFunction': astichi_template(from_astichi_code("""\
def prepare_commit_fields_function_name__astichi_arg__(self):
    astichi_hole(prepare_commit_fields_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=498)), 'ApplyPreparedCommitFieldsFunction': astichi_template(from_astichi_code("""\
def apply_prepared_commit_fields_function_name__astichi_arg__(self):
    astichi_hole(apply_prepared_commit_fields_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=503)), 'RollbackFieldsFunction': astichi_template(from_astichi_code("""\
def rollback_fields_function_name__astichi_arg__(self):
    astichi_hole(rollback_fields_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=508)), 'ApplyPreparedCommitDispatchBranch': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=apply_prepared_commit_fields_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=513)), 'PrepareCommitDispatchBranch': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=prepare_commit_fields_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=522)), 'RollbackDispatchBranch': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=rollback_fields_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=531)), 'BuildDefaultFactoryFactsBody': from_astichi_code("""\
classes = sorted(
    ctx.records(ClassesCollection),
    key=lambda item: item.class_order,
)
