...
def property_setter_name__astichi_arg__(self, value):
    state = self._y_state
    state._y_ensure_working_transaction(astichi_bind_external(tx_index))
    state.astichi_ref(external=working_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=223, keep_names=('VOID',))), 'ManagedPlainPrepareBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot) is not VOID:
    ...
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=240, keep_names=('VOID',))), 'ManagedFreezePrepareBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot) is not VOID:
    astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = (
        freeze_func_name__astichi_arg__(
            astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)
        )
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=249, keep_names=('VOID',))), 'ManagedOptionalFreezePrepareBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot) is not VOID:
    astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = (
        None
    ...
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=260, keep_names=('VOID',))), 'ManagedApplyPreparedCommitBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot) is not VOID:
    ...
    astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)._ = VOID""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=273, keep_names=('VOID',))), 'ManagedRollbackBranch': astichi_template(from_astichi_code("""\
astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = VOID
astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)._ = VOID""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=284, keep_names=('VOID',))), 'PrepareCommitFieldsFunction': astichi_template(from_astichi_code("""\
def prepare_commit_fields_function_name__astichi_arg__(self):
    astichi_hole(prepare_commit_fields_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=291)), 'ApplyPreparedCommitFieldsFunction': astichi_template(from_astichi_code("""\
def apply_prepared_commit_fields_function_name__astichi_arg__(self):
    astichi_hole(apply_prepared_commit_fields_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=296)), 'RollbackFieldsFunction': astichi_template(from_astichi_code("""\
def rollback_fields_function_name__astichi_arg__(self):
    astichi_hole(rollback_fields_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=301)), 'ApplyPreparedCommitDispatchBranch': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=apply_prepared_commit_fields_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=306)), 'PrepareCommitDispatchBranch': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=prepare_commit_fields_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=314)), 'RollbackDispatchBranch': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=rollback_fields_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=322)), 'BuildDefaultFactoryFactsBody': from_astichi_code("""\
classes = sorted(
    ctx.records(ClassesCollection),
    key=lambda item: item.class_order,
)
