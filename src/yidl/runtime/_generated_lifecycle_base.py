...
_TxGroupOrderProperty = RuntimeProperty('TxGroupOrder', int, default=0, storage_name='tx_group_order')
...
_TransactionMethodSpec = RuntimeRecord('TransactionMethod', (_MethodIdProperty, _MethodOwnerProperty, _MethodNameProperty, _MethodKindProperty, _TxGroupKeyProperty, _TxIndexProperty, _DeclarationOrderProperty))
...
_TxGroupSpec = RuntimeRecord('TxGroup', (_TxOwnerProperty, _TxGroupKeyProperty, _TxIndexProperty, _TxGroupOrderProperty, _CommitOrderKeyFunctionNameProperty, _RequiresValidationFunctionNameProperty, _ValidateCommitFunctionNameProperty, _BeforeCommitFunctionNameProperty, _AfterCommitFunctionNameProperty, _AfterRollbackFunctionNameProperty, _PrepareCommitFieldsFunctionNameProperty, _ApplyPreparedCommitFieldsFunctionNameProperty, _RollbackFieldsFunctionNameProperty))
_IndexedTransactionalFieldSpec = RuntimeRecord('IndexedTransactionalField', (_FieldIdProperty, _FieldOwnerProperty, _FieldNameProperty, _FieldOrderProperty, _TxGroupKeyProperty, _TxIndexProperty, _CurrentSlotNameProperty, _WorkingSlotNameProperty, _StagedSlotNameProperty, _HasFreezeProperty, _FreezeParamNameProperty, _HasThawProperty, _ThawParamNameProperty, _HasOptionalNoneProperty))
...
_IndexedTransientFieldSpec = RuntimeRecord('IndexedTransientField', (_FieldIdProperty, _FieldOwnerProperty, _FieldNameProperty, _FieldOrderProperty, _TxGroupKeyProperty, _TxIndexProperty, _CurrentSlotNameProperty, _WorkingSlotNameProperty, _HasWorkingDefaultFactoryProperty, _WorkingDefaultFactoryParamNameProperty))
...
_TransientFieldSpec = RuntimeRecord('TransientField', (_FieldIdProperty, _FieldOwnerProperty, _FieldNameProperty, _FieldOrderProperty, _FieldKindProperty, _AnnotationProperty, _InitProperty, _HasDefaultProperty, _DefaultValueProperty, _DefaultValueParamNameProperty, _HasDefaultFactoryProperty, _DefaultFactoryProperty, _DefaultFactoryParamNameProperty, _DefaultFactoryParamNamesProperty, _HasWorkingDefaultFactoryProperty, _WorkingDefaultFactoryProperty, _WorkingDefaultFactoryParamNameProperty, _WorkingDefaultFactoryParamNamesProperty, _TxGroupKeyProperty, _ValueSlotNameProperty, _CurrentSlotNameProperty, _WorkingSlotNameProperty, _StagedSlotNameProperty, _HasFreezeProperty, _FreezeProperty, _FreezeParamNameProperty, _HasThawProperty, _ThawProperty, _ThawParamNameProperty, _HasOptionalNoneProperty))
_IndexedOwnedFieldSpec = RuntimeRecord('IndexedOwnedField', (_FieldIdProperty, _FieldOwnerProperty, _FieldNameProperty, _FieldOrderProperty, _TxGroupKeyProperty, _TxIndexProperty, _CurrentSlotNameProperty, _WorkingSlotNameProperty, _StagedSlotNameProperty))
_BindingFieldSpec = RuntimeRecord('BindingField', (_FieldIdProperty, _FieldOwnerProperty, _FieldNameProperty, _FieldOrderProperty, _FieldKindProperty, _AnnotationProperty, _InitProperty, _HasDefaultProperty, _DefaultValueProperty, _DefaultValueParamNameProperty, _HasDefaultFactoryProperty, _DefaultFactoryProperty, _DefaultFactoryParamNameProperty, _DefaultFactoryParamNamesProperty, _HasWorkingDefaultFactoryProperty, _WorkingDefaultFactoryProperty, _WorkingDefaultFactoryParamNameProperty, _WorkingDefaultFactoryParamNamesProperty, _TxGroupKeyProperty, _ValueSlotNameProperty, _CurrentSlotNameProperty, _WorkingSlotNameProperty, _StagedSlotNameProperty, _HasFreezeProperty, _FreezeProperty, _FreezeParamNameProperty, _HasThawProperty, _ThawProperty, _ThawParamNameProperty, _HasOptionalNoneProperty))
_OwnedFieldSpec = RuntimeRecord('OwnedField', (_FieldIdProperty, _FieldOwnerProperty, _FieldNameProperty, _FieldOrderProperty, _FieldKindProperty, _AnnotationProperty, _InitProperty, _HasDefaultProperty, _DefaultValueProperty, _DefaultValueParamNameProperty, _HasDefaultFactoryProperty, _DefaultFactoryProperty, _DefaultFactoryParamNameProperty, _DefaultFactoryParamNamesProperty, _HasWorkingDefaultFactoryProperty, _WorkingDefaultFactoryProperty, _WorkingDefaultFactoryParamNameProperty, _WorkingDefaultFactoryParamNamesProperty, _TxGroupKeyProperty, _ValueSlotNameProperty, _CurrentSlotNameProperty, _WorkingSlotNameProperty, _StagedSlotNameProperty, _HasFreezeProperty, _FreezeProperty, _FreezeParamNameProperty, _HasThawProperty, _ThawProperty, _ThawParamNameProperty, _HasOptionalNoneProperty))
_LifecycleFieldSpecUnion = RuntimeUnion('LifecycleFieldSpec', (_PlainFieldSpec, _InitVarFieldSpec, _ClassVarFieldSpec, _ManagedFieldSpec, _TransientFieldSpec, _BindingFieldSpec, _OwnedFieldSpec))
...
class TransactionMethod:
    __slots__ = ('method_id', 'method_owner', 'method_name', 'method_kind', 'tx_group_key', 'tx_index', 'declaration_order')
    ...
    def __init__(self, *, method_id: str, method_owner: str, method_name: str, method_kind: str, tx_group_key: object=None, tx_index: int=0, declaration_order: int=0):
    ...
    def __setattr__(self, name, value):
        if name in ('method_id', 'method_owner', 'method_name', 'method_kind', 'tx_group_key', 'tx_index', 'declaration_order'):
...
class PlainField:
    __slots__ = ('field_id', 'field_owner', 'field_name', 'field_order', 'field_kind', 'annotation', 'init', 'has_default', 'default_value', 'default_value_param_name', 'has_default_factory', 'default_factory', 'default_factory_param_name', 'default_factory_param_names', 'has_working_default_factory', 'working_default_factory', 'working_default_factory_param_name', 'working_default_factory_param_names', 'tx_group_key', 'value_slot_name', 'current_slot_name', 'working_slot_name', 'staged_slot_name', 'has_freeze', 'freeze', 'freeze_param_name', 'has_thaw', 'thaw', 'thaw_param_name', 'has_optional_none')
    ...
    def __setattr__(self, name, value):
        if name in ('field_id', 'field_owner', 'field_name', 'field_order', 'field_kind', 'annotation', 'init', 'has_default', 'default_value', 'default_value_param_name', 'has_default_factory', 'default_factory', 'default_factory_param_name', 'default_factory_param_names', 'has_working_default_factory', 'working_default_factory', 'working_default_factory_param_name', 'working_default_factory_param_names', 'tx_group_key', 'value_slot_name', 'current_slot_name', 'working_slot_name', 'staged_slot_name', 'has_freeze', 'freeze', 'freeze_param_name', 'has_thaw', 'thaw', 'thaw_param_name', 'has_optional_none'):
...
class TransactionalField:
    ...
    def __init__(self, *, field_id: str, field_owner: str, field_name: str, field_order: int, tx_group_key: object=None):
        if not isinstance(field_id, str):
            raise TypeError('FieldId must be str, got ' + type(field_id).__name__)
        object.__setattr__(self, 'field_id', field_id)
        if not isinstance(field_owner, str):
    ...
    def __setattr__(self, name, value):
        if name in ('field_id', 'field_owner', 'field_name', 'field_order', 'tx_group_key'):
...
class TxGroup:
    __slots__ = ('tx_owner', 'tx_group_key', 'tx_index', 'tx_group_order', 'commit_order_key_function_name', 'requires_validation_function_name', 'validate_commit_function_name', 'before_commit_function_name', 'after_commit_function_name', 'after_rollback_function_name', 'prepare_commit_fields_function_name', 'apply_prepared_commit_fields_function_name', 'rollback_fields_function_name')
    ...
    def __init__(self, *, tx_owner: str='', tx_group_key: object=None, tx_index: int=0, tx_group_order: int=0, commit_order_key_function_name: str='', requires_validation_function_name: str='', validate_commit_function_name: str='', before_commit_function_name: str='', after_commit_function_name: str='', after_rollback_function_name: str='', prepare_commit_fields_function_name: str='', apply_prepared_commit_fields_function_name: str='', rollback_fields_function_name: str=''):
        ...
        if not isinstance(tx_group_order, int):
            raise TypeError('TxGroupOrder must be int, got ' + type(tx_group_order).__name__)
    ...
    def __setattr__(self, name, value):
        if name in ('tx_owner', 'tx_group_key', 'tx_index', 'tx_group_order', 'commit_order_key_function_name', 'requires_validation_function_name', 'validate_commit_function_name', 'before_commit_function_name', 'after_commit_function_name', 'after_rollback_function_name', 'prepare_commit_fields_function_name', 'apply_prepared_commit_fields_function_name', 'rollback_fields_function_name'):
...
class IndexedTransactionalField:
    __slots__ = ('field_id', 'field_owner', 'field_name', 'field_order', 'tx_group_key', 'tx_index', 'current_slot_name', 'working_slot_name', 'staged_slot_name', 'has_freeze', 'freeze_param_name', 'has_thaw', 'thaw_param_name', 'has_optional_none')
    ...
    def __init__(self, *, field_id: str, field_owner: str, field_name: str, field_order: int, tx_group_key: object=None, tx_index: int=0, current_slot_name: str='', working_slot_name: str='', staged_slot_name: str='', has_freeze: bool=False, freeze_param_name: str='', has_thaw: bool=False, thaw_param_name: str='', has_optional_none: bool=False):
        if not isinstance(field_id, str):
            raise TypeError('FieldId must be str, got ' + type(field_id).__name__)
        object.__setattr__(self, 'field_id', field_id)
        if not isinstance(field_owner, str):
    ...
    def __setattr__(self, name, value):
        if name in ('field_id', 'field_owner', 'field_name', 'field_order', 'tx_group_key', 'tx_index', 'current_slot_name', 'working_slot_name', 'staged_slot_name', 'has_freeze', 'freeze_param_name', 'has_thaw', 'thaw_param_name', 'has_optional_none'):
...
class DefaultFactoryDependency:
    __slots__ = ('dependency_owner', 'consumer_field_id', 'consumer_field_name', 'provider_name', 'provider_field_id', 'provider_field_kind', 'provider_init', 'provider_has_default', 'provider_has_default_factory', 'param_name', 'param_order', 'consumer_eval_order')
    ...
    def __setattr__(self, name, value):
        if name in ('dependency_owner', 'consumer_field_id', 'consumer_field_name', 'provider_name', 'provider_field_id', 'provider_field_kind', 'provider_init', 'provider_has_default', 'provider_has_default_factory', 'param_name', 'param_order', 'consumer_eval_order'):
...
class DefaultFactoryEvaluationStep:
    __slots__ = ('eval_step_id', 'eval_owner', 'eval_field_id', 'eval_field_name', 'eval_field_kind', 'eval_init', 'eval_state_slot_name', 'eval_default_factory_param_name', 'eval_order', 'eval_statement_order')
    ...
    def __init__(self, *, eval_step_id: str, eval_owner: str, eval_field_id: str, eval_field_name: str, eval_field_kind: str='', eval_init: bool=True, eval_state_slot_name: str='', eval_default_factory_param_name: str='', eval_order: int=0, eval_statement_order: int=0):
    ...
    def __setattr__(self, name, value):
        if name in ('eval_step_id', 'eval_owner', 'eval_field_id', 'eval_field_name', 'eval_field_kind', 'eval_init', 'eval_state_slot_name', 'eval_default_factory_param_name', 'eval_order', 'eval_statement_order'):
...
class IndexedTransientField:
    __slots__ = ('field_id', 'field_owner', 'field_name', 'field_order', 'tx_group_key', 'tx_index', 'current_slot_name', 'working_slot_name', 'has_working_default_factory', 'working_default_factory_param_name')
    ...
    def __init__(self, *, field_id: str, field_owner: str, field_name: str, field_order: int, tx_group_key: object=None, tx_index: int=0, current_slot_name: str='', working_slot_name: str='', has_working_default_factory: bool=False, working_default_factory_param_name: str=''):
        if not isinstance(field_id, str):
            raise TypeError('FieldId must be str, got ' + type(field_id).__name__)
        object.__setattr__(self, 'field_id', field_id)
        if not isinstance(field_owner, str):
    ...
    def __setattr__(self, name, value):
        if name in ('field_id', 'field_owner', 'field_name', 'field_order', 'tx_group_key', 'tx_index', 'current_slot_name', 'working_slot_name', 'has_working_default_factory', 'working_default_factory_param_name'):
...
class IndexedOwnedField:
    __slots__ = ('field_id', 'field_owner', 'field_name', 'field_order', 'tx_group_key', 'tx_index', 'current_slot_name', 'working_slot_name', 'staged_slot_name')
    ...
    def __init__(self, *, field_id: str, field_owner: str, field_name: str, field_order: int, tx_group_key: object=None, tx_index: int=0, current_slot_name: str='', working_slot_name: str='', staged_slot_name: str=''):
        if not isinstance(field_id, str):
            raise TypeError('FieldId must be str, got ' + type(field_id).__name__)
        object.__setattr__(self, 'field_id', field_id)
        if not isinstance(field_owner, str):
    ...
    def __setattr__(self, name, value):
        if name in ('field_id', 'field_owner', 'field_name', 'field_order', 'tx_group_key', 'tx_index', 'current_slot_name', 'working_slot_name', 'staged_slot_name'):
...
TxGroupsCollection = RuntimeCollection('TxGroups', _TxGroupSpec, allows_multiple=True, identity=(_TxOwnerProperty, _TxGroupKeyProperty))
    ...
    for lifecycle_class in classes:
        ...
        for field in fields:
            ...
            if tx_group not in seen:
                ...
                ctx.write(TxGroupsCollection, TxGroup(tx_owner=lifecycle_class.class_id, tx_group_key=tx_group, tx_index=seen[tx_group], tx_group_order=field.field_order, commit_order_key_function_name=f'_commit_order_key_tx_{seen[tx_group]}', requires_validation_function_name=f'_requires_validation_tx_{seen[tx_group]}', validate_commit_function_name=f'_validate_commit_tx_{seen[tx_group]}', before_commit_function_name=f'_before_commit_tx_{seen[tx_group]}', after_commit_function_name=f'_after_commit_tx_{seen[tx_group]}', after_rollback_function_name=f'_after_rollback_tx_{seen[tx_group]}', prepare_commit_fields_function_name=f'_prepare_commit_tx_{seen[tx_group]}_fields', apply_prepared_commit_fields_function_name=f'_apply_prepared_commit_tx_{seen[tx_group]}_fields', rollback_fields_function_name=f'_rollback_tx_{seen[tx_group]}_fields'), policy=RejectDuplicate)
    ...
    for lifecycle_class in classes:
        ...
        for field in factory_fields:
            if field.default_factory_param_names:
                continue
            ctx.write(DefaultFactoryDependenciesCollection, DefaultFactoryDependency(dependency_owner=lifecycle_class.class_id, consumer_field_id=field.field_id, consumer_field_name=field.field_name, provider_name='', provider_field_id='', provider_field_kind='', provider_init=True, provider_has_default=False, provider_has_default_factory=False, param_name='', param_order=-1, consumer_eval_order=eval_order_by_id[field.field_id]), policy=RejectDuplicate)
        for eval_order, field_id in enumerate(ordered_field_ids):
            ...
            if field.field_kind == 'field':
                ...
                state_slot = field.current_slot_name
            ctx.write(DefaultFactoryEvaluationStepsCollection, DefaultFactoryEvaluationStep(eval_step_id=field.field_id, eval_owner=lifecycle_class.class_id, eval_field_id=field.field_id, eval_field_name=field.field_name, eval_field_kind=field.field_kind, eval_init=field.init, eval_state_slot_name=state_slot, eval_default_factory_param_name=field.default_factory_param_name, eval_order=eval_order, eval_statement_order=100000 + eval_order), policy=RejectDuplicate)
...
def run_build_transient_facts(builder):
    ...
    tx_groups = {(tx_group.tx_owner, tx_group.tx_group_key): tx_group.tx_index for tx_group in ctx.records(TxGroupsCollection)}
    for field in fields:
...
def run_build_owned_facts(builder):
    ...
    for field in ctx.records(FieldsCollection):
        ...
        if tx_group is None:
            tx_group = DEFAULT_TRANSACTION
        ctx.write(IndexedOwnedFieldsCollection, IndexedOwnedField(field_id=field.field_id, field_owner=field.field_owner, field_name=field.field_name, field_order=field.field_order, tx_group_key=tx_group, tx_index=tx_groups[field.field_owner, tx_group], current_slot_name=field.current_slot_name, working_slot_name=field.working_slot_name, staged_slot_name=field.staged_slot_name), policy=RejectDuplicate)
...
def build_lifecycle_class(decorated_cls, builder_params__astichi_param_hole__):
    ...
    astichi_hole(return_statement)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=211), 'BuilderParam': astichi_template(from_astichi_code("""\
def astichi_params(*, value_name__astichi_arg__):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=229)), 'TransactionManagerParam': astichi_template(from_astichi_code("""\
def astichi_params(*, transaction_manager=None):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=234)), 'StateSlotEntry': astichi_template(from_astichi_code('astichi_bind_external(slot_name)', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=239)), 'InitParamRequired': astichi_template(from_astichi_code("""\
def astichi_params(param_name__astichi_arg__: astichi_bind_external(annotation)):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=243)), 'InitParamDefault': astichi_template(from_astichi_code("""\
def astichi_params(
    param_name__astichi_arg__: astichi_bind_external(annotation)
    = default_value_name__astichi_arg__
):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=248)), 'PlainStateAssignment': astichi_template(from_astichi_code("""\
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = astichi_pass(
    init_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=256)), 'InitVarLocalDefaultAssignment': astichi_template(from_astichi_code("""\
init_value_name__astichi_arg__ = astichi_pass(
    default_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=263)), 'PlainProperty': astichi_template(from_astichi_code("""\
@property
...
def property_setter_name__astichi_arg__(self, value):
    self._y_state.astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=270)), 'ClassVarDefaultAssignment': astichi_template(from_astichi_code("""\
classvar_name__astichi_arg__ = astichi_pass(
    classvar_value_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=280)), 'CommitOrderKeyBranch': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        return astichi_pass(
            self,
            outer_bind=True,
        )._y_get_default_facade().astichi_ref(external=method_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=287)), 'RequiresValidationBranch': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        return True""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=296)), 'ValidateCommitBranch': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        result = astichi_pass(
            self,
        ...
        if result is False:
            return False""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=302)), 'TransactionHookCall': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        astichi_pass(
            self,
            outer_bind=True,
        )._y_get_default_facade().astichi_ref(external=method_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=313)), 'ClassBundle': astichi_template(from_astichi_code("""\
...
class working_facade_class_decl_name__astichi_arg__(
    ...
    __slots__ = ()
    astichi_hole(working_facade_properties)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=322, keep_names=('DEFAULT_TRANSACTION', 'TransactionManager', 'VOID', 'weakref', '_HAS_DEFAULT_FACTORY'))), 'ReturnClass': astichi_template(from_astichi_code("""\
...
return return_class_result_ref__astichi_arg__""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=613)), 'PassStatement': astichi_template(from_astichi_code('pass', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=629)), 'BuildTransactionFactsBody': from_astichi_code("""\
from yidl.runtime.transaction_yidl import DEFAULT_TRANSACTION
...
for lifecycle_class in classes:
    ...
    for field in fields:
        ...
        ctx.write(
            ...
            policy=RejectDuplicate,
        )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=77, keep_names=('ctx', 'ClassesCollection', 'FieldsCollection', 'TxGroupsCollection', 'TransactionalFieldsCollection', 'IndexedTransactionalFieldsCollection', 'TxGroup', 'TransactionalField', 'IndexedTransactionalField', 'RejectDuplicate')), 'ManagedCurrentStateAssignment': astichi_template(from_astichi_code("""\
...
def requires_validation_function_name__astichi_arg__(self):
    ...
    return False""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=392)), 'ValidateCommitFunction': astichi_template(from_astichi_code("""\
def validate_commit_function_name__astichi_arg__(self):
    astichi_hole(validate_commit_tx_body)
    return True""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=398)), 'BeforeCommitFunction': astichi_template(from_astichi_code("""\
def before_commit_function_name__astichi_arg__(self):
    astichi_hole(before_commit_tx_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=404)), 'AfterCommitFunction': astichi_template(from_astichi_code("""\
def after_commit_function_name__astichi_arg__(self):
    astichi_hole(after_commit_tx_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=409)), 'AfterRollbackFunction': astichi_template(from_astichi_code("""\
def after_rollback_function_name__astichi_arg__(self):
    astichi_hole(after_rollback_tx_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=414)), 'CommitOrderKeyHelperCall': astichi_template(from_astichi_code("""\
return astichi_pass(
    self,
    outer_bind=True,
)._y_get_default_facade().astichi_ref(external=method_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=419)), 'RequiresValidationHelperCall': astichi_template(from_astichi_code('return True', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=426)), 'ValidateCommitHelperCall': astichi_template(from_astichi_code("""\
result = astichi_pass(
    self,
    outer_bind=True,
)._y_get_default_facade().astichi_ref(external=method_name)()
if not result:
    return result""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=430)), 'TransactionHookHelperCall': astichi_template(from_astichi_code("""\
astichi_pass(
    self,
    outer_bind=True,
)._y_get_default_facade().astichi_ref(external=method_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=439)), 'CommitOrderKeyDispatchCall': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        return astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=commit_order_key_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=446)), 'RequiresValidationDispatchCall': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        return astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=requires_validation_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=455)), 'ValidateCommitDispatchCall': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        return astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=validate_commit_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=464)), 'BeforeCommitDispatchCall': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=before_commit_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=473)), 'AfterCommitDispatchCall': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=after_commit_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=482)), 'AfterRollbackDispatchCall': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=after_rollback_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=491)), 'PrepareCommitFieldsFunction': astichi_template(from_astichi_code("""\
def prepare_commit_fields_function_name__astichi_arg__(self):
    astichi_hole(prepare_commit_fields_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=500)), 'ApplyPreparedCommitFieldsFunction': astichi_template(from_astichi_code("""\
def apply_prepared_commit_fields_function_name__astichi_arg__(self):
    astichi_hole(apply_prepared_commit_fields_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=505)), 'RollbackFieldsFunction': astichi_template(from_astichi_code("""\
def rollback_fields_function_name__astichi_arg__(self):
    astichi_hole(rollback_fields_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=510)), 'ApplyPreparedCommitDispatchBranch': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=apply_prepared_commit_fields_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=515)), 'PrepareCommitDispatchBranch': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=prepare_commit_fields_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=524)), 'RollbackDispatchBranch': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        astichi_pass(
            self,
            outer_bind=True,
        ).astichi_ref(external=rollback_fields_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=533)), 'BuildDefaultFactoryFactsBody': from_astichi_code("""\
classes = sorted(
    ctx.records(ClassesCollection),
    key=lambda item: item.class_order,
)
...
for lifecycle_class in classes:
    ...
    for eval_order, field_id in enumerate(ordered_field_ids):
        ...
        ctx.write(
            ...
            policy=RejectDuplicate,
        )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=85, keep_names=('ctx', 'ClassesCollection', 'FieldsCollection', 'DefaultFactoryDependenciesCollection', 'DefaultFactoryEvaluationStepsCollection', 'DefaultFactoryDiagnosticsCollection', 'DefaultFactoryDependency', 'DefaultFactoryEvaluationStep', 'DefaultFactoryDiagnostic', 'RejectDuplicate', 'ReplaceExisting')), 'RaiseDefaultFactoryDiagnosticsBody': from_astichi_code("""\
for diagnostic in ctx.records(DefaultFactoryDiagnosticsCollection):
    raise AssemblyDiagnosticError(diagnostic.diagnostic_message)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=298, keep_names=('ctx', 'DefaultFactoryDiagnosticsCollection', 'AssemblyDiagnosticError')), 'InitParamDefaultFactory': astichi_template(from_astichi_code("""\
def astichi_params(
    param_name__astichi_arg__: astichi_bind_external(annotation)
    = _HAS_DEFAULT_FACTORY
):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=314, keep_names=('_HAS_DEFAULT_FACTORY',))), 'StoredDefaultFactoryEvalInit': astichi_template(from_astichi_code("""\
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = astichi_pass(
    ...
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=324, keep_names=('_HAS_DEFAULT_FACTORY',))), 'StoredDefaultFactoryEvalNoInit': astichi_template(from_astichi_code("""\
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = astichi_pass(
    field_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=339)), 'InitVarDefaultFactoryEvalInit': astichi_template(from_astichi_code("""\
if astichi_pass(field_name__astichi_arg__, outer_bind=True) is _HAS_DEFAULT_FACTORY:
    astichi_pass(field_name__astichi_arg__, outer_bind=True)._ = (
        default_factory_name__astichi_arg__(
            **astichi_hole(default_factory_args)
        )
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=349, keep_names=('_HAS_DEFAULT_FACTORY',))), 'InitVarDefaultFactoryEvalNoInit': astichi_template(from_astichi_code("""\
field_name__astichi_arg__ = default_factory_name__astichi_arg__(
    **astichi_hole(default_factory_args)
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=360)), 'DefaultFactoryStoredArg': astichi_template(from_astichi_code("""\
astichi_funcargs(
    param_name__astichi_arg__=astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=provider_name)
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=366)), 'DefaultFactoryLocalArg': astichi_template(from_astichi_code("""\
astichi_funcargs(
    param_name__astichi_arg__=astichi_pass(
        provider_name__astichi_arg__,
        outer_bind=True,
    )
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=375)), 'DefaultFactoryEmptyArg': astichi_template(from_astichi_code('astichi_funcargs()', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=384)), 'BuildTransientFactsBody': from_astichi_code("""\
from yidl.runtime.transaction_yidl import DEFAULT_TRANSACTION
...
for field in ctx.records(FieldsCollection):
    ...
    ctx.write(
        ...
        policy=RejectDuplicate,
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=35, keep_names=('ctx', 'FieldsCollection', 'TxGroupsCollection', 'IndexedOwnedFieldsCollection', 'IndexedOwnedField', 'RejectDuplicate')), 'BindingSupportHelper': from_astichi_code("""\
def _y_validate_binding_value(field_name, value):
    ...
    return value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=74), 'OwnedScalarStateAssignment': astichi_template(from_astichi_code("""\
...
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=86)), 'OwnedEmptyStateAssignment': astichi_template(from_astichi_code('astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = VOID', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=93, keep_names=('VOID',))), 'OwnedDefaultProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
    if state.astichi_ref(external=working_slot) is not VOID:
...
def property_setter_name__astichi_arg__(self, value):
    ...
    state.astichi_ref(external=working_slot)._ = (
        _y_validate_binding_value(astichi_bind_external(field_name), value)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=99, keep_names=('VOID',))), 'OwnedCurrentProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    return self._y_state.astichi_ref(external=current_slot)
...
def property_setter_name__astichi_arg__(self, value):
    ...
    raise AttributeError(
        ...
        + astichi_bind_external(field_name)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=118)), 'OwnedWorkingProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
    if state.astichi_ref(external=working_slot) is not VOID:
...
def property_setter_name__astichi_arg__(self, value):
    ...
    state.astichi_ref(external=working_slot)._ = (
        _y_validate_binding_value(astichi_bind_external(field_name), value)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=132, keep_names=('VOID',))), 'OwnedPrepareCommitBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot) is not VOID:
    value = astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)
    if value is not None:
        value.accepted()
    astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=151, keep_names=('VOID',))), 'OwnedApplyPreparedCommitBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot) is not VOID:
    astichi_pass(self, outer_bind=True).astichi_ref(external=current_slot)._ = (
        astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)
    )
    astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = VOID
    astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)._ = VOID""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=161, keep_names=('VOID',))), 'OwnedRollbackBranch': astichi_template(from_astichi_code("""\
astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = VOID
astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)._ = VOID""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=172, keep_names=('VOID',))), 'BindingStateAssignment': astichi_template(from_astichi_code("""\
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = (
    _y_validate_binding_value(
        astichi_bind_external(field_name),
        astichi_pass(init_value_name__astichi_arg__, outer_bind=True),
    )
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=179)), 'BindingProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    return self._y_state.astichi_ref(external=state_slot)
...
def property_setter_name__astichi_arg__(self, value):
    self._y_state.astichi_ref(external=state_slot)._ = (
        _y_validate_binding_value(astichi_bind_external(field_name), value)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=188)), 'BindingDefaultFactoryEvalInit': astichi_template(from_astichi_code("""\
if astichi_pass(field_name__astichi_arg__, outer_bind=True) is _HAS_DEFAULT_FACTORY:
    astichi_pass(field_name__astichi_arg__, outer_bind=True)._ = (
        default_factory_name__astichi_arg__(
            **astichi_hole(default_factory_args)
...
astichi_pass(self, outer_bind=True).astichi_ref(external=property_name)._ = astichi_pass(
    field_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=200, keep_names=('_HAS_DEFAULT_FACTORY',))), 'BindingDefaultFactoryEvalNoInit': astichi_template(from_astichi_code("""\
field_name__astichi_arg__ = default_factory_name__astichi_arg__(
    **astichi_hole(default_factory_args)
)
astichi_pass(self, outer_bind=True).astichi_ref(external=property_name)._ = astichi_pass(
