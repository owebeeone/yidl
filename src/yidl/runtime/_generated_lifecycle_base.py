...
_IndexedOwnedFieldSpec = RuntimeRecord('IndexedOwnedField', (_FieldIdProperty, _FieldOwnerProperty, _FieldNameProperty, _FieldOrderProperty, _BindingShapeProperty, _TxGroupKeyProperty, _TxIndexProperty, _CurrentSlotNameProperty, _WorkingSlotNameProperty, _StagedSlotNameProperty))
...
class IndexedOwnedField:
    __slots__ = ('field_id', 'field_owner', 'field_name', 'field_order', 'binding_shape', 'tx_group_key', 'tx_index', 'current_slot_name', 'working_slot_name', 'staged_slot_name')
    ...
    def __init__(self, *, field_id: str, field_owner: str, field_name: str, field_order: int, binding_shape: str='scalar', tx_group_key: object=None, tx_index: int=0, current_slot_name: str='', working_slot_name: str='', staged_slot_name: str=''):
        if not isinstance(field_id, str):
            raise TypeError('FieldId must be str, got ' + type(field_id).__name__)
        object.__setattr__(self, 'field_id', field_id)
        if not isinstance(field_owner, str):
    ...
    def __setattr__(self, name, value):
        if name in ('field_id', 'field_owner', 'field_name', 'field_order', 'binding_shape', 'tx_group_key', 'tx_index', 'current_slot_name', 'working_slot_name', 'staged_slot_name'):
...
def run_build_owned_facts(builder):
    ...
    for field in ctx.records(FieldsCollection):
        ...
        if tx_group is None:
            tx_group = DEFAULT_TRANSACTION
        ctx.write(IndexedOwnedFieldsCollection, IndexedOwnedField(field_id=field.field_id, field_owner=field.field_owner, field_name=field.field_name, field_order=field.field_order, binding_shape=field.binding_shape, tx_group_key=tx_group, tx_index=tx_groups[field.field_owner, tx_group], current_slot_name=field.current_slot_name, working_slot_name=field.working_slot_name, staged_slot_name=field.staged_slot_name), policy=RejectDuplicate)
...
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        return astichi_pass(
            self,
            outer_bind=True,
        )._y_get_default_facade().astichi_ref(external=method_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=289)), 'RequiresValidationBranch': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
...
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        ...
        if result is False:
            return False""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=304)), 'TransactionHookCall': astichi_template(from_astichi_code("""\
match astichi_pass(tx_index, outer_bind=True):
    case _ if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
        astichi_pass(
            self,
            outer_bind=True,
        )._y_get_default_facade().astichi_ref(external=method_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=315)), 'ClassBundle': astichi_template(from_astichi_code("""\
...
class working_facade_class_decl_name__astichi_arg__(
    ...
    __slots__ = ()
    astichi_hole(working_facade_properties)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_core.yidl', line_number=324, keep_names=('DEFAULT_TRANSACTION', 'TransactionManager', 'VOID', 'weakref', '_HAS_DEFAULT_FACTORY'))), 'ReturnClass': astichi_template(from_astichi_code("""\
...
for lifecycle_class in classes:
    ...
    for eval_order, field_id in enumerate(ordered_field_ids):
        ...
        ctx.write(
            ...
            policy=RejectDuplicate,
        )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=87, keep_names=('ctx', 'ClassesCollection', 'FieldsCollection', 'DefaultFactoryDependenciesCollection', 'DefaultFactoryEvaluationStepsCollection', 'DefaultFactoryDiagnosticsCollection', 'DefaultFactoryDependency', 'DefaultFactoryEvaluationStep', 'DefaultFactoryDiagnostic', 'RejectDuplicate', 'ReplaceExisting')), 'RaiseDefaultFactoryDiagnosticsBody': from_astichi_code("""\
for diagnostic in ctx.records(DefaultFactoryDiagnosticsCollection):
    raise AssemblyDiagnosticError(diagnostic.diagnostic_message)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=301, keep_names=('ctx', 'DefaultFactoryDiagnosticsCollection', 'AssemblyDiagnosticError')), 'InitParamDefaultFactory': astichi_template(from_astichi_code("""\
def astichi_params(
    param_name__astichi_arg__: astichi_bind_external(annotation)
    = _HAS_DEFAULT_FACTORY
):
    pass""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=317, keep_names=('_HAS_DEFAULT_FACTORY',))), 'StoredDefaultFactoryEvalInit': astichi_template(from_astichi_code("""\
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = astichi_pass(
    ...
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=327, keep_names=('_HAS_DEFAULT_FACTORY',))), 'StoredDefaultFactoryEvalNoInit': astichi_template(from_astichi_code("""\
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = astichi_pass(
    field_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=342)), 'InitVarDefaultFactoryEvalInit': astichi_template(from_astichi_code("""\
if astichi_pass(field_name__astichi_arg__, outer_bind=True) is _HAS_DEFAULT_FACTORY:
    astichi_pass(field_name__astichi_arg__, outer_bind=True)._ = (
        default_factory_name__astichi_arg__(
            **astichi_hole(default_factory_args)
        )
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=352, keep_names=('_HAS_DEFAULT_FACTORY',))), 'InitVarDefaultFactoryEvalNoInit': astichi_template(from_astichi_code("""\
field_name__astichi_arg__ = default_factory_name__astichi_arg__(
    **astichi_hole(default_factory_args)
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=363)), 'DefaultFactoryStoredArg': astichi_template(from_astichi_code("""\
astichi_funcargs(
    param_name__astichi_arg__=astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=provider_name)
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=369)), 'DefaultFactoryLocalArg': astichi_template(from_astichi_code("""\
astichi_funcargs(
    param_name__astichi_arg__=astichi_pass(
        provider_name__astichi_arg__,
        outer_bind=True,
    )
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=378)), 'DefaultFactoryEmptyArg': astichi_template(from_astichi_code('astichi_funcargs()', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_default_factories.yidl', line_number=387)), 'BuildTransientFactsBody': from_astichi_code("""\
from yidl.runtime.transaction_yidl import DEFAULT_TRANSACTION
...
for field in ctx.records(FieldsCollection):
    ...
    ctx.write(
        ...
        policy=RejectDuplicate,
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=44, keep_names=('ctx', 'FieldsCollection', 'TxGroupsCollection', 'IndexedOwnedFieldsCollection', 'IndexedOwnedField', 'RejectDuplicate')), 'BindingSupportHelper': from_astichi_code("""\
...
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=121)), 'OwnedMapStateAssignment': astichi_template(from_astichi_code("""\
value = astichi_pass(init_value_name__astichi_arg__, outer_bind=True)
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = (
    _y_validate_binding_map_value(astichi_bind_external(field_name), value)
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=128)), 'OwnedEmptyStateAssignment': astichi_template(from_astichi_code('astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = VOID', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=135, keep_names=('VOID',))), 'OwnedDefaultProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
    if state.astichi_ref(external=working_slot) is not VOID:
...
def property_setter_name__astichi_arg__(self, value):
    ...
    state.astichi_ref(external=working_slot)._ = (
        _y_validate_binding_value(astichi_bind_external(field_name), value)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=141, keep_names=('VOID',))), 'OwnedMapDefaultProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
    if state.astichi_ref(external=working_slot) is not VOID:
...
def property_setter_name__astichi_arg__(self, value):
    ...
    state.astichi_ref(external=working_slot)._ = (
        _y_validate_binding_map_value(astichi_bind_external(field_name), value)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=160, keep_names=('VOID',))), 'OwnedCurrentProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    return self._y_state.astichi_ref(external=current_slot)
...
def property_setter_name__astichi_arg__(self, value):
    ...
    raise AttributeError(
        ...
        + astichi_bind_external(field_name)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=179)), 'OwnedWorkingProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
    if state.astichi_ref(external=working_slot) is not VOID:
...
def property_setter_name__astichi_arg__(self, value):
    ...
    state.astichi_ref(external=working_slot)._ = (
        _y_validate_binding_value(astichi_bind_external(field_name), value)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=193, keep_names=('VOID',))), 'OwnedMapWorkingProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
    if state.astichi_ref(external=working_slot) is not VOID:
...
def property_setter_name__astichi_arg__(self, value):
    ...
    state.astichi_ref(external=working_slot)._ = (
        _y_validate_binding_map_value(astichi_bind_external(field_name), value)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=212, keep_names=('VOID',))), 'OwnedPrepareCommitBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot) is not VOID:
    value = astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)
    if value is not None:
        value.accepted()
    astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=231, keep_names=('VOID',))), 'OwnedMapPrepareCommitBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot) is not VOID:
    value = astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)
    if value is not None:
        for item in value.values():
            item.accepted()
    astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=241, keep_names=('VOID',))), 'OwnedScalarDefaultFactoryEvalInit': astichi_template(from_astichi_code("""\
if astichi_pass(field_name__astichi_arg__, outer_bind=True) is _HAS_DEFAULT_FACTORY:
    astichi_pass(field_name__astichi_arg__, outer_bind=True)._ = (
        default_factory_name__astichi_arg__(
            **astichi_hole(default_factory_args)
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=252, keep_names=('_HAS_DEFAULT_FACTORY',))), 'OwnedScalarDefaultFactoryEvalNoInit': astichi_template(from_astichi_code("""\
field_name__astichi_arg__ = default_factory_name__astichi_arg__(
    **astichi_hole(default_factory_args)
)
value = astichi_pass(field_name__astichi_arg__, outer_bind=True)
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=271)), 'OwnedMapDefaultFactoryEvalInit': astichi_template(from_astichi_code("""\
if astichi_pass(field_name__astichi_arg__, outer_bind=True) is _HAS_DEFAULT_FACTORY:
    astichi_pass(field_name__astichi_arg__, outer_bind=True)._ = (
        default_factory_name__astichi_arg__(
            **astichi_hole(default_factory_args)
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=285, keep_names=('_HAS_DEFAULT_FACTORY',))), 'OwnedMapDefaultFactoryEvalNoInit': astichi_template(from_astichi_code("""\
field_name__astichi_arg__ = default_factory_name__astichi_arg__(
    **astichi_hole(default_factory_args)
)
value = astichi_pass(field_name__astichi_arg__, outer_bind=True)
...
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=318)), 'OwnedApplyPreparedCommitBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot) is not VOID:
    astichi_pass(self, outer_bind=True).astichi_ref(external=current_slot)._ = (
        astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)
    )
    astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = VOID
    astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)._ = VOID""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=346, keep_names=('VOID',))), 'OwnedRollbackBranch': astichi_template(from_astichi_code("""\
astichi_pass(self, outer_bind=True).astichi_ref(external=staged_slot)._ = VOID
astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)._ = VOID""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=357, keep_names=('VOID',))), 'BindingStateAssignment': astichi_template(from_astichi_code("""\
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = (
    _y_validate_binding_value(
        astichi_bind_external(field_name),
        astichi_pass(init_value_name__astichi_arg__, outer_bind=True),
    )
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=364)), 'BindingMapStateAssignment': astichi_template(from_astichi_code("""\
astichi_pass(state, outer_bind=True).astichi_ref(external=state_slot)._ = (
    _y_validate_binding_map_value(
        astichi_bind_external(field_name),
        astichi_pass(init_value_name__astichi_arg__, outer_bind=True),
    )
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=373)), 'BindingProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    return self._y_state.astichi_ref(external=state_slot)
...
def property_setter_name__astichi_arg__(self, value):
    self._y_state.astichi_ref(external=state_slot)._ = (
        _y_validate_binding_value(astichi_bind_external(field_name), value)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=382)), 'BindingMapProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    return self._y_state.astichi_ref(external=state_slot)
...
def property_setter_name__astichi_arg__(self, value):
    self._y_state.astichi_ref(external=state_slot)._ = (
        _y_validate_binding_map_value(astichi_bind_external(field_name), value)
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=394)), 'BindingDefaultFactoryEvalInit': astichi_template(from_astichi_code("""\
if astichi_pass(field_name__astichi_arg__, outer_bind=True) is _HAS_DEFAULT_FACTORY:
    astichi_pass(field_name__astichi_arg__, outer_bind=True)._ = (
        default_factory_name__astichi_arg__(
            **astichi_hole(default_factory_args)
...
astichi_pass(self, outer_bind=True).astichi_ref(external=property_name)._ = astichi_pass(
    field_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=406, keep_names=('_HAS_DEFAULT_FACTORY',))), 'BindingDefaultFactoryEvalNoInit': astichi_template(from_astichi_code("""\
field_name__astichi_arg__ = default_factory_name__astichi_arg__(
    **astichi_hole(default_factory_args)
)
astichi_pass(self, outer_bind=True).astichi_ref(external=property_name)._ = astichi_pass(
    field_name__astichi_arg__,
    outer_bind=True,
)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_owned.yidl', line_number=421))}
