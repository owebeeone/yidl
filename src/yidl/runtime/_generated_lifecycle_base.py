...
_TxGroupSpec = RuntimeRecord('TxGroup', (_TxOwnerProperty, _TxGroupKeyProperty, _TxIndexProperty, _TxGroupOrderProperty, _ApplyPreparedCommitFieldsFunctionNameProperty, _RollbackFieldsFunctionNameProperty))
...
class TxGroup:
    __slots__ = ('tx_owner', 'tx_group_key', 'tx_index', 'tx_group_order', 'apply_prepared_commit_fields_function_name', 'rollback_fields_function_name')
    ...
    def __init__(self, *, tx_owner: str='', tx_group_key: object=None, tx_index: int=0, tx_group_order: int=0, apply_prepared_commit_fields_function_name: str='', rollback_fields_function_name: str=''):
    ...
    def __setattr__(self, name, value):
        if name in ('tx_owner', 'tx_group_key', 'tx_index', 'tx_group_order', 'apply_prepared_commit_fields_function_name', 'rollback_fields_function_name'):
...
class IndexedTransactionalField:
    __slots__ = ('field_id', 'field_owner', 'field_name', 'field_order', 'tx_group_key', 'tx_index', 'current_slot_name', 'working_slot_name')
    ...
    def __init__(self, *, field_id: str, field_owner: str, field_name: str, field_order: int, tx_group_key: object=None, tx_index: int=0, current_slot_name: str='', working_slot_name: str=''):
        if not isinstance(field_id, str):
            raise TypeError('FieldId must be str, got ' + type(field_id).__name__)
        object.__setattr__(self, 'field_id', field_id)
        if not isinstance(field_owner, str):
    ...
    def __setattr__(self, name, value):
        if name in ('field_id', 'field_owner', 'field_name', 'field_order', 'tx_group_key', 'tx_index', 'current_slot_name', 'working_slot_name'):
...
def run_build_transaction_facts(builder):
    ...
    for lifecycle_class in classes:
        ...
        ctx.write(TxGroupsCollection, TxGroup(tx_owner=lifecycle_class.class_id, tx_group_key=DEFAULT_TRANSACTION, tx_index=0, tx_group_order=0, apply_prepared_commit_fields_function_name='_apply_prepared_commit_tx_0_fields', rollback_fields_function_name='_rollback_tx_0_fields'), policy=RejectDuplicate)
        for field in fields:
...
def property_setter_name__astichi_arg__(self, value):
    ...
    state.astichi_ref(external=working_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=168, keep_names=('VOID',))), 'ManagedCurrentProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
...
def property_setter_name__astichi_arg__(self, value):
    ...
    )""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=185)), 'ManagedWorkingProperty': astichi_template(from_astichi_code("""\
@property
def property_getter_name__astichi_arg__(self):
    state = self._y_state
    if state.astichi_ref(external=working_slot) is not VOID:
...
def property_setter_name__astichi_arg__(self, value):
    state = self._y_state
    state._y_ensure_working_transaction(astichi_bind_external(tx_index))
    state.astichi_ref(external=working_slot)._ = value""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=199, keep_names=('VOID',))), 'ManagedCommitBranch': astichi_template(from_astichi_code("""\
if astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot) is not VOID:
    ...
    astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)._ = VOID""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=216, keep_names=('VOID',))), 'ManagedRollbackBranch': astichi_template(from_astichi_code('astichi_pass(self, outer_bind=True).astichi_ref(external=working_slot)._ = VOID', file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=226, keep_names=('VOID',))), 'ApplyPreparedCommitFieldsFunction': astichi_template(from_astichi_code("""\
def apply_prepared_commit_fields_function_name__astichi_arg__(self):
    astichi_hole(apply_prepared_commit_fields_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=232)), 'RollbackFieldsFunction': astichi_template(from_astichi_code("""\
def rollback_fields_function_name__astichi_arg__(self):
    astichi_hole(rollback_fields_body)""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=237)), 'ApplyPreparedCommitDispatchBranch': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=apply_prepared_commit_fields_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=242)), 'RollbackDispatchBranch': astichi_template(from_astichi_code("""\
if astichi_pass(tx_index, outer_bind=True) == astichi_bind_external(tx_index_value):
    astichi_pass(
        self,
        outer_bind=True,
    ).astichi_ref(external=rollback_fields_function_name)()""", file_name='tests/data/yidl/yidl_transactional_lifecycle/lifecycle_managed.yidl', line_number=250)), 'BuildDefaultFactoryFactsBody': from_astichi_code("""\
classes = sorted(
    ctx.records(ClassesCollection),
    key=lambda item: item.class_order,
)
